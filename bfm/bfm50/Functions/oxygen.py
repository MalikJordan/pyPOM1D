...
def calculate_oxygen_reaeration(oxygen_reaeration_parameters, environmental_parameters, constant_parameters, conc, temper, salt, wind):
    ...
    wind_dependency = (oxygen_reaeration_parameters["d"]*(wind**2))*numpy.sqrt(schmidt_ratio_disOxygen_IO_O)*constant_parameters["cm2m"]*constant_parameters["hours_per_day"]/constant_parameters["sec_per_day"]
