...
species_names = ['disOxygen_IO_O', 'phospate_IO_P', 'nitrate_IO_N', 'ammonium_IO_N', 'O4n', 'silicate_IO_Si', 'reductEquiv_IO_R', 'pelBacteria_LO_C', 'pelBacteria_LO_N', 'pelBacteria_LO_P', 
                 ...
                 'Z6c', 'Z6n', 'Z6p', 'labileDOM_NO_C', 'labileDOM_NO_N', 'labileDOM_NO_P', 'semilabileDOC_NO_C', 'semirefractDOC_NO_C', 'particOrganDetritus_NO_C', 
                 'particOrganDetritus_NO_N', 'particOrganDetritus_NO_P', 'particOrganDetritus_NO_Si', 'disInorgCarbon_IO_C', 'O3h']
...
def bfm50_rate_eqns(time, conc, seasonal_cycle=True):
    ...
    dmicrozoo_LO_Cdt_prd, dZ6cdt_prd, ic5, in5, ip5, ic6, in6, ip6 = get_microzoo_predation_terms(conc, microzoo5_parameters, microzoo6_parameters, zoo_availability_parameters, environmental_parameters, constant_parameters, temper)
    ...
    (dZ6cdt_rel_labileDOM_NO_C, dZ6cdt_rel_particOrganDetritus_NO_C, dZ6cdt_rsp_disInorgCarbon_IO_C, dZ6ndt_rel_labileDOM_NO_N, dZ6ndt_rel_particOrganDetritus_NO_N, dZ6pdt_rel_labileDOM_NO_P, dZ6pdt_rel_particOrganDetritus_NO_P,  
     dZ6pdt_rel_phospate_IO_P, dZ6ndt_rel_ammonium_IO_N) = microzoo_eqns(conc, microzoo6_parameters, constant_parameters, environmental_parameters, z6c, z6n, z6p, ic6, in6, ip6, temper)
    ...
    ddisOxygen_IO_O_dt = (constant_parameters["omega_c"]*((ddiatoms_LO_Cdt_gpp_disInorgCarbon_IO_C - ddiatoms_LO_Cdt_rsp_disInorgCarbon_IO_C) + (dnanoflagellates_LO_Cdt_gpp_disInorgCarbon_IO_C - dnanoflagellates_LO_Cdt_rsp_disInorgCarbon_IO_C) + (dpicophyto_LO_Cdt_gpp_disInorgCarbon_IO_C - dpicophyto_LO_Cdt_rsp_disInorgCarbon_IO_C) + (dlargephyto_LO_Cdt_gpp_disInorgCarbon_IO_C - dlargephyto_LO_Cdt_rsp_disInorgCarbon_IO_C)) - 
               ...
               constant_parameters["omega_c"]*(dcarnivMesozoo_LO_Cdt_rsp_disInorgCarbon_IO_C + domnivMesozoo_LO_Cdt_rsp_disInorgCarbon_IO_C + dmicrozoo_LO_Cdt_rsp_disInorgCarbon_IO_C + dZ6cdt_rsp_disInorgCarbon_IO_C) - 
    ...
    # Bacterioplankton
    dpelBacteria_LO_C_dt = dBcdt_upt_labileDOM_NO_C + dBcdt_upt_particOrganDetritus_NO_C - dBcdt_rsp_disInorgCarbon_IO_C - dBcdt_lys_labileDOM_NO_C - dBcdt_lys_particOrganDetritus_NO_C - (dmicrozoo_LO_Cdt_prd["b1"] + dZ6cdt_prd["b1"])
    ...
    dpelBacteria_LO_P_dt = (labileDOM_NO_P_labileDOM_NO_C*dBcdt_upt_labileDOM_NO_C) + (particOrganDetritus_NO_P_particOrganDetritus_NO_C*dBcdt_upt_particOrganDetritus_NO_C) - (dBpdt_upt_rel_phospate_IO_P*insw_vector(dBpdt_upt_rel_phospate_IO_P)) + ((-1)*f_B_p*dBpdt_upt_rel_phospate_IO_P*insw_vector(-dBpdt_upt_rel_phospate_IO_P)) - dBcdt_lys_labileDOM_NO_P - dBcdt_lys_particOrganDetritus_NO_P - (bp_bc*(dmicrozoo_LO_Cdt_prd["b1"] + dZ6cdt_prd["b1"]))

    # Phytoplankton
    ddiatoms_LO_C_dt = ddiatoms_LO_Cdt_gpp_disInorgCarbon_IO_C - ddiatoms_LO_Cdt_exu_semilabileDOC_NO_C - ddiatoms_LO_Cdt_rsp_disInorgCarbon_IO_C - ddiatoms_LO_Cdt_lys_labileDOM_NO_C - ddiatoms_LO_Cdt_lys_particOrganDetritus_NO_C - dcarnivMesozoo_LO_Cdt_prd["p1"] - domnivMesozoo_LO_Cdt_prd["p1"] - dmicrozoo_LO_Cdt_prd["p1"] - dZ6cdt_prd["p1"]
    ddiatoms_LO_N_dt = ddiatoms_LO_Ndt_upt_nitrate_IO_N + ddiatoms_LO_Ndt_upt_ammonium_IO_N - extra_n1 - ddiatoms_LO_Ndt_lys_labileDOM_NO_N - ddiatoms_LO_Ndt_lys_particOrganDetritus_NO_N - (diatoms_LO_N_diatoms_LO_C*(dcarnivMesozoo_LO_Cdt_prd["p1"] + domnivMesozoo_LO_Cdt_prd["p1"] + dmicrozoo_LO_Cdt_prd["p1"] + dZ6cdt_prd["p1"]))
    ddiatoms_LO_P_dt = ddiatoms_LO_Pdt_upt_phospate_IO_P - ddiatoms_LO_Pdt_upt_labileDOM_NO_P - ddiatoms_LO_Pdt_lys_labileDOM_NO_P - ddiatoms_LO_Pdt_lys_particOrganDetritus_NO_P - (diatoms_LO_P_diatoms_LO_C*(dcarnivMesozoo_LO_Cdt_prd["p1"] + domnivMesozoo_LO_Cdt_prd["p1"] + dmicrozoo_LO_Cdt_prd["p1"] + dZ6cdt_prd["p1"]))
    ddiatoms_LO_Chl_dt = ddiatoms_LO_Chldt_syn - (diatoms_LO_Chl_diatoms_LO_C*(dcarnivMesozoo_LO_Cdt_prd["p1"] + domnivMesozoo_LO_Cdt_prd["p1"] + dmicrozoo_LO_Cdt_prd["p1"] + dZ6cdt_prd["p1"]))
    ddiatoms_LO_Si_dt = ddiatoms_LO_Sidt_upt_silicate_IO_Si - ddiatoms_LO_Sidt_lys_particOrganDetritus_NO_Si - (diatoms_LO_Si_diatoms_LO_C*(dcarnivMesozoo_LO_Cdt_prd["p1"] + domnivMesozoo_LO_Cdt_prd["p1"] + dmicrozoo_LO_Cdt_prd["p1"] + dZ6cdt_prd["p1"]))
    
    dnanoflagellates_LO_C_dt = dnanoflagellates_LO_Cdt_gpp_disInorgCarbon_IO_C - dnanoflagellates_LO_Cdt_exu_semilabileDOC_NO_C - dnanoflagellates_LO_Cdt_rsp_disInorgCarbon_IO_C - dnanoflagellates_LO_Cdt_lys_labileDOM_NO_C - dnanoflagellates_LO_Cdt_lys_particOrganDetritus_NO_C - dcarnivMesozoo_LO_Cdt_prd["p2"] - domnivMesozoo_LO_Cdt_prd["p2"] - dmicrozoo_LO_Cdt_prd["p2"] - dZ6cdt_prd["p2"]
    dnanoflagellates_LO_N_dt = dnanoflagellates_LO_Ndt_upt_nitrate_IO_N + dnanoflagellates_LO_Ndt_upt_ammonium_IO_N - extra_n2 - dnanoflagellates_LO_Ndt_lys_labileDOM_NO_N - dnanoflagellates_LO_Ndt_lys_particOrganDetritus_NO_N - (nanoflagellates_LO_N_nanoflagellates_LO_C*(dcarnivMesozoo_LO_Cdt_prd["p2"] + domnivMesozoo_LO_Cdt_prd["p2"] + dmicrozoo_LO_Cdt_prd["p2"] + dZ6cdt_prd["p2"]))
    dnanoflagellates_LO_P_dt = dnanoflagellates_LO_Pdt_upt_phospate_IO_P - dnanoflagellates_LO_Pdt_upt_labileDOM_NO_P - dnanoflagellates_LO_Pdt_lys_labileDOM_NO_P - dnanoflagellates_LO_Pdt_lys_particOrganDetritus_NO_P - (nanoflagellates_LO_P_nanoflagellates_LO_C*(dcarnivMesozoo_LO_Cdt_prd["p2"] + domnivMesozoo_LO_Cdt_prd["p2"] + dmicrozoo_LO_Cdt_prd["p2"] + dZ6cdt_prd["p2"]))
    dnanoflagellates_LO_Chl_dt = dnanoflagellates_LO_Chldt_syn - (nanoflagellates_LO_Chl_nanoflagellates_LO_C*(dcarnivMesozoo_LO_Cdt_prd["p2"] + domnivMesozoo_LO_Cdt_prd["p2"] + dmicrozoo_LO_Cdt_prd["p2"] + dZ6cdt_prd["p2"]))
    
    dpicophyto_LO_C_dt = dpicophyto_LO_Cdt_gpp_disInorgCarbon_IO_C - dpicophyto_LO_Cdt_exu_semilabileDOC_NO_C - dpicophyto_LO_Cdt_rsp_disInorgCarbon_IO_C - dpicophyto_LO_Cdt_lys_labileDOM_NO_C - dpicophyto_LO_Cdt_lys_particOrganDetritus_NO_C - dcarnivMesozoo_LO_Cdt_prd["p3"] - domnivMesozoo_LO_Cdt_prd["p3"] - dmicrozoo_LO_Cdt_prd["p3"] - dZ6cdt_prd["p3"]
    dpicophyto_LO_N_dt = dpicophyto_LO_Ndt_upt_nitrate_IO_N + dpicophyto_LO_Ndt_upt_ammonium_IO_N - extra_n3 - dpicophyto_LO_Ndt_lys_labileDOM_NO_N - dpicophyto_LO_Ndt_lys_particOrganDetritus_NO_N - (picophyto_LO_N_picophyto_LO_C*(dcarnivMesozoo_LO_Cdt_prd["p3"] + domnivMesozoo_LO_Cdt_prd["p3"] + dmicrozoo_LO_Cdt_prd["p3"] + dZ6cdt_prd["p3"]))
    dpicophyto_LO_P_dt = dpicophyto_LO_Pdt_upt_phospate_IO_P - dpicophyto_LO_Pdt_upt_labileDOM_NO_P - dpicophyto_LO_Pdt_lys_labileDOM_NO_P - dpicophyto_LO_Pdt_lys_particOrganDetritus_NO_P - (picophyto_LO_P_picophyto_LO_C*(dcarnivMesozoo_LO_Cdt_prd["p3"] + domnivMesozoo_LO_Cdt_prd["p3"] + dmicrozoo_LO_Cdt_prd["p3"] + dZ6cdt_prd["p3"]))
    dpicophyto_LO_Chl_dt = dpicophyto_LO_Chldt_syn - (picophyto_LO_Chl_picophyto_LO_C*(dcarnivMesozoo_LO_Cdt_prd["p3"] + domnivMesozoo_LO_Cdt_prd["p3"] + dmicrozoo_LO_Cdt_prd["p3"] + dZ6cdt_prd["p3"]))
    ...
    dlargephyto_LO_Chl_dt = dlargephyto_LO_Chldt_syn - (largephyto_LO_Chl_largephyto_LO_C*(dcarnivMesozoo_LO_Cdt_prd["p4"] + domnivMesozoo_LO_Cdt_prd["p4"] + dmicrozoo_LO_Cdt_prd["p4"] + dZ6cdt_prd["p4"]))
    ...
    domnivMesozoo_LO_N_dt = diatoms_LO_N_diatoms_LO_C*domnivMesozoo_LO_Cdt_prd["p1"] + nanoflagellates_LO_N_nanoflagellates_LO_C*domnivMesozoo_LO_Cdt_prd["p2"] + picophyto_LO_N_picophyto_LO_C*domnivMesozoo_LO_Cdt_prd["p3"] + largephyto_LO_N_largephyto_LO_C*domnivMesozoo_LO_Cdt_prd["p4"] + carnivMesozoo_LO_N_carnivMesozoo_LO_C*domnivMesozoo_LO_Cdt_prd["z3"] + microzoo_LO_N_microzoo_LO_C*domnivMesozoo_LO_Cdt_prd["z5"] + z6n_z6c*domnivMesozoo_LO_Cdt_prd["z6"] - omnivMesozoo_LO_N_omnivMesozoo_LO_C*dcarnivMesozoo_LO_Cdt_prd["z4"] - domnivMesozoo_LO_Ndt_rel_labileDOM_NO_N - domnivMesozoo_LO_Ndt_rel_particOrganDetritus_NO_N - domnivMesozoo_LO_Ndt_rel_ammonium_IO_N
    domnivMesozoo_LO_P_dt = diatoms_LO_P_diatoms_LO_C*domnivMesozoo_LO_Cdt_prd["p1"] + nanoflagellates_LO_P_nanoflagellates_LO_C*domnivMesozoo_LO_Cdt_prd["p2"] + picophyto_LO_P_picophyto_LO_C*domnivMesozoo_LO_Cdt_prd["p3"] + largephyto_LO_P_largephyto_LO_C*domnivMesozoo_LO_Cdt_prd["p4"] + carnivMesozoo_LO_P_carnivMesozoo_LO_C*domnivMesozoo_LO_Cdt_prd["z3"] + microzoo_LO_P_microzoo_LO_C*domnivMesozoo_LO_Cdt_prd["z5"] + z6p_z6c*domnivMesozoo_LO_Cdt_prd["z6"] - omnivMesozoo_LO_P_omnivMesozoo_LO_C*dcarnivMesozoo_LO_Cdt_prd["z4"] - domnivMesozoo_LO_Pdt_rel_labileDOM_NO_P - domnivMesozoo_LO_Pdt_rel_particOrganDetritus_NO_P - domnivMesozoo_LO_Pdt_rel_phospate_IO_P
    
    # microzooplankton
    dmicrozoo_LO_C_dt = dmicrozoo_LO_Cdt_prd["b1"] + dmicrozoo_LO_Cdt_prd["p1"] + dmicrozoo_LO_Cdt_prd["p2"] + dmicrozoo_LO_Cdt_prd["p3"] + dmicrozoo_LO_Cdt_prd["p4"] + dmicrozoo_LO_Cdt_prd["z6"] - dcarnivMesozoo_LO_Cdt_prd["z5"] - domnivMesozoo_LO_Cdt_prd["z5"] - dZ6cdt_prd["z5"] - dmicrozoo_LO_Cdt_rel_labileDOM_NO_C - dmicrozoo_LO_Cdt_rel_particOrganDetritus_NO_C - dmicrozoo_LO_Cdt_rsp_disInorgCarbon_IO_C
    dmicrozoo_LO_N_dt = bn_bc*dmicrozoo_LO_Cdt_prd["b1"] + diatoms_LO_N_diatoms_LO_C*dmicrozoo_LO_Cdt_prd["p1"] + nanoflagellates_LO_N_nanoflagellates_LO_C*dmicrozoo_LO_Cdt_prd["p2"] + picophyto_LO_N_picophyto_LO_C*dmicrozoo_LO_Cdt_prd["p3"] + largephyto_LO_N_largephyto_LO_C*dmicrozoo_LO_Cdt_prd["p4"] + z6n_z6c*dmicrozoo_LO_Cdt_prd["z6"] - microzoo_LO_N_microzoo_LO_C*dcarnivMesozoo_LO_Cdt_prd["z5"] - microzoo_LO_N_microzoo_LO_C*domnivMesozoo_LO_Cdt_prd["z5"] - microzoo_LO_N_microzoo_LO_C*dZ6cdt_prd["z5"] - dmicrozoo_LO_Ndt_rel_labileDOM_NO_N - dmicrozoo_LO_Ndt_rel_particOrganDetritus_NO_N - dmicrozoo_LO_Ndt_rel_ammonium_IO_N
    dmicrozoo_LO_P_dt = bp_bc*dmicrozoo_LO_Cdt_prd["b1"] + diatoms_LO_P_diatoms_LO_C*dmicrozoo_LO_Cdt_prd["p1"] + nanoflagellates_LO_P_nanoflagellates_LO_C*dmicrozoo_LO_Cdt_prd["p2"] + picophyto_LO_P_picophyto_LO_C*dmicrozoo_LO_Cdt_prd["p3"] + largephyto_LO_P_largephyto_LO_C*dmicrozoo_LO_Cdt_prd["p4"] + z6p_z6c*dmicrozoo_LO_Cdt_prd["z6"] - microzoo_LO_P_microzoo_LO_C*dcarnivMesozoo_LO_Cdt_prd["z5"] - microzoo_LO_P_microzoo_LO_C*domnivMesozoo_LO_Cdt_prd["z5"] - microzoo_LO_P_microzoo_LO_C*dZ6cdt_prd["z5"] - dmicrozoo_LO_Pdt_rel_labileDOM_NO_P - dmicrozoo_LO_Pdt_rel_particOrganDetritus_NO_P - dmicrozoo_LO_Pdt_rel_phospate_IO_P
    
    dz6c_dt = dZ6cdt_prd["b1"] + dZ6cdt_prd["p1"] + dZ6cdt_prd["p2"] + dZ6cdt_prd["p3"] + dZ6cdt_prd["p4"] + dZ6cdt_prd["z5"] - dcarnivMesozoo_LO_Cdt_prd["z6"] - domnivMesozoo_LO_Cdt_prd["z6"] - dmicrozoo_LO_Cdt_prd["z6"] - dZ6cdt_rel_labileDOM_NO_C - dZ6cdt_rel_particOrganDetritus_NO_C - dZ6cdt_rsp_disInorgCarbon_IO_C
    dz6n_dt = bn_bc*dZ6cdt_prd["b1"] + diatoms_LO_N_diatoms_LO_C*dZ6cdt_prd["p1"] + nanoflagellates_LO_N_nanoflagellates_LO_C*dZ6cdt_prd["p2"] + picophyto_LO_N_picophyto_LO_C*dZ6cdt_prd["p3"] + largephyto_LO_N_largephyto_LO_C*dZ6cdt_prd["p4"] + microzoo_LO_N_microzoo_LO_C*dZ6cdt_prd["z5"] - z6n_z6c*dcarnivMesozoo_LO_Cdt_prd["z6"] - z6n_z6c*domnivMesozoo_LO_Cdt_prd["z6"] - z6n_z6c*dmicrozoo_LO_Cdt_prd["z6"] - dZ6ndt_rel_labileDOM_NO_N - dZ6ndt_rel_particOrganDetritus_NO_N - dZ6ndt_rel_ammonium_IO_N
    dz6p_dt = bp_bc*dZ6cdt_prd["b1"] + diatoms_LO_P_diatoms_LO_C*dZ6cdt_prd["p1"] + nanoflagellates_LO_P_nanoflagellates_LO_C*dZ6cdt_prd["p2"] + picophyto_LO_P_picophyto_LO_C*dZ6cdt_prd["p3"] + largephyto_LO_P_largephyto_LO_C*dZ6cdt_prd["p4"] + microzoo_LO_P_microzoo_LO_C*dZ6cdt_prd["z5"] - z6p_z6c*dcarnivMesozoo_LO_Cdt_prd["z6"] - z6p_z6c*domnivMesozoo_LO_Cdt_prd["z6"] - z6p_z6c*dmicrozoo_LO_Cdt_prd["z6"] - dZ6pdt_rel_labileDOM_NO_P - dZ6pdt_rel_particOrganDetritus_NO_P - dZ6pdt_rel_phospate_IO_P

    # DOM
    dlabileDOM_NO_C_dt = (ddiatoms_LO_Cdt_lys_labileDOM_NO_C + dnanoflagellates_LO_Cdt_lys_labileDOM_NO_C + dpicophyto_LO_Cdt_lys_labileDOM_NO_C + dlargephyto_LO_Cdt_lys_labileDOM_NO_C) + dBcdt_lys_labileDOM_NO_C - dBcdt_upt_labileDOM_NO_C + (dmicrozoo_LO_Cdt_rel_labileDOM_NO_C + dZ6cdt_rel_labileDOM_NO_C)
    dlabileDOM_NO_N_dt = (ddiatoms_LO_Ndt_lys_labileDOM_NO_N + dnanoflagellates_LO_Ndt_lys_labileDOM_NO_N + dpicophyto_LO_Ndt_lys_labileDOM_NO_N + dlargephyto_LO_Ndt_lys_labileDOM_NO_N) + (extra_n1 + extra_n2 + extra_n3 + extra_n4) + dBcdt_lys_labileDOM_NO_N - dBcdt_upt_labileDOM_NO_C*labileDOM_NO_N_labileDOM_NO_C + (dmicrozoo_LO_Ndt_rel_labileDOM_NO_N + dZ6ndt_rel_labileDOM_NO_N)
    dlabileDOM_NO_P_dt = (ddiatoms_LO_Pdt_lys_labileDOM_NO_P + dnanoflagellates_LO_Pdt_lys_labileDOM_NO_P + dpicophyto_LO_Pdt_lys_labileDOM_NO_P + dlargephyto_LO_Pdt_lys_labileDOM_NO_P) + (ddiatoms_LO_Pdt_upt_labileDOM_NO_P + dnanoflagellates_LO_Pdt_upt_labileDOM_NO_P + dpicophyto_LO_Pdt_upt_labileDOM_NO_P + dlargephyto_LO_Pdt_upt_labileDOM_NO_P) + dBcdt_lys_labileDOM_NO_P - dBcdt_upt_labileDOM_NO_C*labileDOM_NO_P_labileDOM_NO_C + (dmicrozoo_LO_Pdt_rel_labileDOM_NO_P + dZ6pdt_rel_labileDOM_NO_P)
    ...
    return [ddisOxygen_IO_O_dt, dphospate_IO_P_dt, dnitrate_IO_N_dt, dammonium_IO_N_dt, do4n_dt, dsilicate_IO_Si_dt, dreductEquiv_IO_R_dt, dpelBacteria_LO_C_dt, dpelBacteria_LO_N_dt, dpelBacteria_LO_P_dt, 
            ...
            domnivMesozoo_LO_C_dt, domnivMesozoo_LO_N_dt, domnivMesozoo_LO_P_dt, dmicrozoo_LO_C_dt, dmicrozoo_LO_N_dt, dmicrozoo_LO_P_dt, dz6c_dt, dz6n_dt, dz6p_dt, dlabileDOM_NO_C_dt, dlabileDOM_NO_N_dt, dlabileDOM_NO_P_dt, 
            dsemilabileDOC_NO_C_dt, dsemirefractDOC_NO_C_dt, dparticOrganDetritus_NO_C_dt, dparticOrganDetritus_NO_N_dt, dparticOrganDetritus_NO_P_dt, dparticOrganDetritus_NO_Si_dt, ddisInorgCarbon_IO_C_dt, do3h_dt]
